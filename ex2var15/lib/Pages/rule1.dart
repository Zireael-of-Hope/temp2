...
class PageRule1 extends StatelessWidget {
  const PageRule1({super.key, required this.listForTable, required this.tailRow});
              ...
              children: [
                SizedBox(
                  child: ElevatedButton(
                    onPressed: () => BlocProvider.of<MainBloc>(context).add(InitialPage()),
